/**
 * Page liste des bilans — COSP (identique CANOPE + accès jeunes externes).
 */
...
export default async function CospBilansPage({ params }: Props) {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-[var(--text-secondary)]">
            Bilans VAK/RIASEC/DISC — élèves MIABO et jeunes externes.
          </p>
        </div>
        <Link
          href={`/${locale}/cosp/bilans/nouveau`}
      ...
      <AssessmentListClient locale={locale} basePath="cosp" />
    </div>
  )
}
