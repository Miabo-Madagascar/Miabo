...
export function VakFocusTopBar({ i, questions, answers, onNavigate, onExit }: Props) {
  return (
    <div className="relative z-10 mx-auto max-w-5xl px-6 pt-6">
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-3">
          <span className="font-display text-[13px] font-bold text-slate-900">Profil VAK</span>
