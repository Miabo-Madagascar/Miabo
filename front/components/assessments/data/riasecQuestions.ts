...
export const RIASEC_QUESTIONS: RiasecQuestion[] = [
  ...
  { id:  9, text: "J'aime suivre des cours de dessin mécanique (ex : plans techniques, schémas de pièces).",  type: "R" },
  ...
  { id: 15, text: "J'aime travailler à un projet scientifique (ex : expérience, étude, recherche).",   type: "I" },
  ...
  { id: 21, text: "J'aime observer des phénomènes physiques (ex : aimants, lumière, chutes d'objets).",  type: "I" },
  { id: 22, text: "J'aime observer et analyser des faits (ex : lire des statistiques, comprendre un événement).", type: "I" },
  ...
  { id: 26, text: "J'aime faire des plans de meubles (ex : dessiner une armoire à construire, schéma d'agencement).", type: "A" },
  ...
  { id: 45, text: "J'aime influencer les autres (ex : convaincre, motiver, inspirer autour de moi).",  type: "E" },
  ...
  { id: 57, text: "J'aime tenir des registres détaillés de dépenses (ex : carnet de budget, tableau de comptes).", type: "C" },
  { id: 58, text: "J'aime classer des lettres, des rapports et des dossiers.",                          type: "C" },
  { id: 59, text: "J'aime écrire des lettres d'affaires (ex : emails professionnels, courriers formels).", type: "C" },
  ...
  { id: 63, text: "J'aime transcrire un texte et effectuer la mise en page (ex : recopier et formater un document).", type: "C" },
